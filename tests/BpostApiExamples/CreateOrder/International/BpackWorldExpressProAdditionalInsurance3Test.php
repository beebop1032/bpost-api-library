...
class BpackWorldExpressProAdditionalInsurance3Test extends PHPUnit_Framework_TestCase
{
    ...
    {
        $order = new Order('bpack world Express Pro - Ins(El)');
...
<tns:order 
    ...
    <tns:reference>bpack world Express Pro - Ins(El)</tns:reference>
