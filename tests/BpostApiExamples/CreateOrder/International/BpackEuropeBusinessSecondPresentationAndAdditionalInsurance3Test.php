...
class BpackEuropeBusinessSecondPresentationAndAdditionalInsurance3Test extends PHPUnit_Framework_TestCase
{
    ...
    {
        $order = new Order('bpack Europe Business - Ins(El)');
...
<tns:order
    ...
    <tns:reference>bpack Europe Business - Ins(El)</tns:reference>
