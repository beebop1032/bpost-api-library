...
class BpackWorldExpressProNoOptionsTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $order = new Order('bpack world Express Pro - No options');
        ...
        $box->setRemark('bpack world Express Pro - No options');
...
<tns:order 
    ...
    <tns:reference>bpack world Express Pro - No options</tns:reference>
    ...
    <tns:box>
        ...
        <tns:remark>bpack world Express Pro - No options</tns:remark>
